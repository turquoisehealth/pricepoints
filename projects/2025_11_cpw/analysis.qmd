...
dfw_provider_counts_df |>
  ...
  labs(
    x = "",
    y = "Facility count",
    title = "Cost Plus has a narrower network than most other TX insurers",
    subtitle = paste0(
    ...
    caption = paste0(
      ...
      "Other payers' facility counts are the total number of unique provider ",
      "locations within their Transparency in Coverage pricing files\n",
      "Includes only facilities in the Dallas-Fort Worth-Arlington, TX CBSA "
    )
  ) +
