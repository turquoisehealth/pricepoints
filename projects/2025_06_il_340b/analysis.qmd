...
ggplot() +
  ...
  labs(
    title = "The OBBB will disqualify hundreds of 340B hospitals",
    subtitle = paste0(
      "Medicaid cuts will drop many hospitals below the 340B DSH ",
...
ggplot() +
  ...
  labs(
    ...
    subtitle = paste0(
      ...
      "(just above the DSH threshold) see the biggest losses"
    ),
    caption = paste0(
      "Post-OBBB DSH percentage is estimated using data from the 2023 CMS ",
      "reports and state Medicaid cut estimates from the KFF\n",
...
ggplot() +
  ...
  labs(
    ...
    subtitle = paste0(
      "Mid-sized DSH hospitals are the most likely to lose 340B qualification"
    ),
    caption = paste0(
