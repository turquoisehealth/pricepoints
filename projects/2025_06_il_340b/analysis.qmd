...
# Create a circle pack graph showing the distribution of outpatient drug profits
# among Illinois 340B hospitals
il_graph <- tribble(
  ~"from", ~"to",
...
ggraph(g, layout = "circlepack", weight = net_out_profit) + 
  ...
  labs(
    ...
    caption = paste0(
      "Circles are scaled based on the upper bound of estimated ",
      "outpatient drug profit<br>",
      "Not all hospitals are shown (some are missing data required to ",
      "estimate drug profits)<br>",
      "\"Chicago area\" includes Cook, DuPage, Kane, Lake, and McHenry counties"
    )
  ) +
  coord_cartesian(
    xlim = c(-6e4, 6e4),
