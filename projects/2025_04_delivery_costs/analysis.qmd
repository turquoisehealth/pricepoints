...
ggplot(aes(y = mmr, x = med_rate)) +
  ...
  labs(
    title = "As delivery price increases, maternal mortality decreases",
    subtitle = "States with the lowest delivery prices also have the highest maternal mortality",
    x = "Delivery price",
    ...
    caption = paste0(
      ...
      " deaths per 100,000 live births. Not all states are shown"
    )
  ) +
  theme(
    plot.title = element_text(
